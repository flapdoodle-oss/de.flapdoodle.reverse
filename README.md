...
Stable (Maven Central Repository, Released: 18.03.2017 - wait 24hrs for [maven central](http://repo1.maven.org/maven2/de/flapdoodle/transition/de.flapdoodle.transition/maven-metadata.xml))
